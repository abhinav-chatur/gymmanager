...
const AddmemberShip = ({handleClose}) => {
    ...
    const fetchMembership = async () => {
        await axios.get(`${process.env.REACT_APP_API_URL}/plans/get-membership`, { withCredentials: true }).then((res) => {
            console.log(res);
    ...
    const handleAddmembership = async()=>{
        await axios.post(`${process.env.REACT_APP_API_URL}/plans/add-membership`,inputField,{ withCredentials: true }).then((response=>{
