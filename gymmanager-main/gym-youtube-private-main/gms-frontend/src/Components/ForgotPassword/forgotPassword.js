...
const ForgotPassword = () => {
    ...
    const changePassword = async()=>{
        setLoader(true)
        await axios.post(`${process.env.REACT_APP_API_URL}/auth/reset-password`,{email:inputField.email,newPassword:inputField.newPassword}).then((response)=>{
    ...
    const sendOtp = async()=>{
        setLoader(true);
        await axios.post(`${process.env.REACT_APP_API_URL}/auth/reset-password/sendOt`,{email:inputField.email}).then((response)=>{
            setEmailSubmit(true)
