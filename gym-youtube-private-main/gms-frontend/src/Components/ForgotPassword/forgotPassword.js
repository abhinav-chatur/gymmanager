...
const ForgotPassword = () => {
    ...
    const changePassword = async()=>{
        setLoader(true)
        await axios.post('https://gymmanager-fjgs.onrender.com/auth/reset-password',{email:inputField.email,newPassword:inputField.newPassword}).then((response)=>{
    ...
    const verifyOTP = async()=>{
        setLoader(true);
        await axios.post('https://gymmanager-fjgs.onrender.com/auth/reset-password/checkOtp',{email:inputField.email,otp:inputField.otp}).then((response)=>{
            setOtpValidate(true)
    ...
    const sendOtp = async()=>{
        setLoader(true);
        await axios.post('https://gymmanager-fjgs.onrender.com/auth/reset-password/sendOtp',{email:inputField.email}).then((response)=>{
            setEmailSubmit(true)
